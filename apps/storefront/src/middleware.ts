...
const STOREFRONT_PREVIEW = process.env.NEXT_PUBLIC_STOREFRONT_PREVIEW === "1"
...
export async function middleware(request: NextRequest) {
  // Preview visual aislado: la URL ya incluye /pe. No consultamos regiones de
  // Medusa hasta que el catálogo comercial y sus precios sean aprobados.
  if (STOREFRONT_PREVIEW) {
